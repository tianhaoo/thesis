<footer>
        <div class="widewrapper footer">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 footer-widget">
                        <h3> <i class="fa fa-pencil"></i> Featured Post </h3>
                        <ul class="clean-list">
                            @foreach($featuredPosts as $featuredPost)
                                <li><a href="/post/{{ $featuredPost->slug }}">{{ $featuredPost->title }}</a></li>
                            @endforeach
                        </ul>
                    </div>
        ...
        <div class="widewrapper copyright">
                &copy; 苏州大学538实验室 <a href="https://Tianhaoo.github.io"  target="_blank">Tianhaoo</a>
        </div>
</footer>